	    ...
	    new preLoader(portImage, {
	    	onComplete : function(load, errors){
	    		$.each(portfolio, function(a, b){
					...
					var portList = $('<figure class="portfolio-view" style="width:' + portWidth + 'px;height:' + (portWidth-113) + 'px"><img src="' + image + '"><figcaption><h2>' + b.title + '</span></h2><a href="' + b.link + '">View more</a></figcaption></figure>');
